...
<body class="home-page home-01 ">
									 	...
									 	@if(Auth::user()->utype === 'ADM')
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu curency" >
													...
													<li class="menu-item">
														<a tittle="Sale setting" href="{{ route('admin.sale') }}"> Sale Settting</a>
													</li>
													<li class="menu-item">
			...
			<div class="coppy-right-box">
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">Copyright © 2020 Roatek Technologies. All rights reserved</p>
					</div>
	...
	<script src="https://cdn.tiny.cloud/1/9dendwjkcobf62thop8fp7aq700lfq7u1j00571amkwt5dfg/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
    @livewireScripts
